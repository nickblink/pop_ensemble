...
# Local inputs
inputs = c('R=2:dataset=NY:N_models=3:n.sample=5000:burnin=2500:family=normal:use_softmax=T:variances=100,100,100:means=100,100,100:rho=0.3:tau2=1:sigma2=100:sigma2_prior_shape=50:sigma2_prior_rate=0.5:tau2_prior_shape=1:tau2_prior_rate=1:num_y_samples=3:stan_path=code/CAR_leroux_sparse_normal.stan:CV_blocks=0:return_quantiles=T:parallel=F:output_path=simTEST_today-not\r','3')
