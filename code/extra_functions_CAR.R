...
prep_stan_data_leroux_sparse <- function(data, W, models, outcome = 'y', use_softmax = F, use_pivot = F, use_normal = T, sigma2_prior_shape = 1, sigma2_prior_rate = 10, theta_prior_shape = NULL, theta_prior_rate = NULL, tau2_prior_shape = 1, tau2_prior_rate = 1, fixed_rho = - 1, fixed_tau2 = -1, theta_gamma_prior = 0, alpha_variance_prior = NULL, family = NULL, rho = NULL, tau2 = NULL, Z = NULL, phi_noncentered = NULL, ...){
  # checking columns
  ...
  if(!is.null(phi_noncentered)){
    stan_data <- c(stan_data, list(phi_noncentered = phi_noncentered))
  }
